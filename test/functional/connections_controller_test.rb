...
class ConnectionsControllerTest < ActionController::TestCase
  ...
  test "should create connection" do
    assert_difference('Connection.count') do
      post :create, connection: { num_connections: @connection.num_connections, read_at: @connection.read_at, user_id: @connection.user_id }
    end
  ...
  test "should update connection" do
    put :update, id: @connection, connection: { num_connections: @connection.num_connections, read_at: @connection.read_at, user_id: @connection.user_id }
    assert_redirected_to connection_path(assigns(:connection))
  end
