...
class TitlesControllerTest < ActionController::TestCase
  ...
  test "should create title" do
    assert_difference('Title.count') do
      post :create, title: { headline: @title.headline, read_at: @title.read_at, user_id: @title.user_id }
    end
  ...
  test "should update title" do
    put :update, id: @title, title: { headline: @title.headline, read_at: @title.read_at, user_id: @title.user_id }
    assert_redirected_to title_path(assigns(:title))
  end
